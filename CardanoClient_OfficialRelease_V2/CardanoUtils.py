...
class MasterDatum(PlutusData):
    ...
    stats: RegistryStats
    asset_name_scheme_for_humans: bytes
    asset_name_example_for_humans: bytes
    asset_name_description_for_humans: bytes
...
#   MintDocument=0, Pause=1, Resume=2, RotateKey=3,
#   LinkForward=4, LinkBackward=5, SweepFunds=6
# ══════════════════════════════════════════════════════════════════════════════
...
@dataclass
class SweepFunds(PlutusData):
    CONSTR_ID = 6
    amount: int
    to_address: PlutusAddress
    signature: bytes


RegistryAction = Union[
    MintDocument, Pause, Resume, RotateKey, LinkForward, LinkBackward, SweepFunds
]
...
class AikenBlueprint:
    ...
    MODULE      = "zpepg_registry_contract"
    VALIDATOR   = "archive_registry"
    SPEND_TITLE = "zpepg_registry_contract.archive_registry.spend"
    MINT_TITLE  = "zpepg_registry_contract.archive_registry.mint"

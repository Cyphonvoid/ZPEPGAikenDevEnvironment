...
# ════════════════════════════════════════════════════════════════════════
# 12. link_forward — already set, contract rejects
# ════════════════════════════════════════════════════════════════════════

section("12. link_forward() — already set, contract should reject")
...
print_receipt(r)
check("link_forward already set — fails", r, expect_success=False,
      checks={"operation": "link_forward"})

# ════════════════════════════════════════════════════════════════════════
# 13. link_backward — already set, contract rejects
# ════════════════════════════════════════════════════════════════════════

section("13. link_backward() — already set, contract should reject")
...
print_receipt(r)
check("link_backward already set — fails", r, expect_success=False,
